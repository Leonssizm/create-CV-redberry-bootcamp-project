...
function validateStartDateInput_3() {
  ...
  if (!isFilled(startDateInputValue)) {
    setError(startDateInputElement_3, '', 'startDateLabel');
...
function validateEndDateInput_3() {
  ...
  if (!isFilled(endDateInputValue)) {
    setError(endDateInputElement_3, '', 'endDateLabel');
...
function validateDescriptionInput_3() {
  ...
  if (!isFilled(descriptionValue)) {
    ...
    jobDescriptionInputElement_3.classList.add('validatedCheckLargeInputs');
